...
import '/index.dart';
import 'reportplanner_copy_widget.dart' show ReportplannerCopyWidget;
import 'package:flutter/material.dart';

class ReportplannerCopyModel extends FlutterFlowModel<ReportplannerCopyWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in reportplannerCopy widget.
