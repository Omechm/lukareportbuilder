    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case InspectionTasksRow:
            return InspectionTasksRow(data);
          case UnexecutedTasksRow:
          ...
          case PlannedTaskRow:
            return PlannedTaskRow(data);
          case UserClientAssignmentsRow:
            return UserClientAssignmentsRow(data);
          case NonCompliantTaskExecutionGroupRow:
            return NonCompliantTaskExecutionGroupRow(data);
          case ChoiceOptionsRow:
            return ChoiceOptionsRow(data);
          case MenuItemsRolesRow:
            return MenuItemsRolesRow(data);
          case FieldTypesRow:
