...
class DocumentationWidget extends StatefulWidget {
  ...
  static String routeName = 'Documentation';
  static String routePath = '/documentation';
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Secure your application with our robust authentication system.',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Learn how to efficiently store and retrieve data from our platform.',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Connect your application with third-party services using our API.',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
