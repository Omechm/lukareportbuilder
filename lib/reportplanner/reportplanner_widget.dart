...
import 'reportplanner_model.dart';
export 'reportplanner_model.dart';

class ReportplannerWidget extends StatefulWidget {
  const ReportplannerWidget({
    super.key,
    int? pageNumber,
  ...
  static String routeName = 'reportplanner';
  static String routePath = '/reportplanner2';

  @override
  State<ReportplannerWidget> createState() => _ReportplannerWidgetState();
}

class _ReportplannerWidgetState extends State<ReportplannerWidget> {
  late ReportplannerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportplannerModel());
