...
class FieldsJsonStruct extends BaseStruct {
  FieldsJsonStruct({
    String? value,
    String? fieldId,
    int? orderId,
  ...
  static FieldsJsonStruct fromMap(Map<String, dynamic> data) =>
      FieldsJsonStruct(
  ...
  static FieldsJsonStruct? maybeFromMap(dynamic data) => data is Map
      ? FieldsJsonStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static FieldsJsonStruct fromSerializableMap(Map<String, dynamic> data) =>
      FieldsJsonStruct(
  ...
  @override
  String toString() => 'FieldsJsonStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is FieldsJsonStruct &&
        value == other.value &&
...
FieldsJsonStruct createFieldsJsonStruct({
  String? value,
  String? fieldId,
  int? orderId,
  String? picName,
