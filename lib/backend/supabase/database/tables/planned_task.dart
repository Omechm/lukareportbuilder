...
class PlannedTaskTable extends SupabaseTable<PlannedTaskRow> {
  @override
  String get tableName => 'planned_task';

  @override
  PlannedTaskRow createRow(Map<String, dynamic> data) => PlannedTaskRow(data);
}

class PlannedTaskRow extends SupabaseDataRow {
  PlannedTaskRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => PlannedTaskTable();
