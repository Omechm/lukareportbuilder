...
class ExecutedTaskNameTable extends SupabaseTable<ExecutedTaskNameRow> {
  @override
  String get tableName => 'executed_task_name';

  @override
  ExecutedTaskNameRow createRow(Map<String, dynamic> data) =>
      ExecutedTaskNameRow(data);
}

class ExecutedTaskNameRow extends SupabaseDataRow {
  ExecutedTaskNameRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ExecutedTaskNameTable();
