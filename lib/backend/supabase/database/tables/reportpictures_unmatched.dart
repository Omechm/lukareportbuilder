...
class ReportpicturesUnmatchedTable
    extends SupabaseTable<ReportpicturesUnmatchedRow> {
  @override
  String get tableName => 'reportpictures_unmatched';

  @override
  ReportpicturesUnmatchedRow createRow(Map<String, dynamic> data) =>
      ReportpicturesUnmatchedRow(data);
}

class ReportpicturesUnmatchedRow extends SupabaseDataRow {
  ReportpicturesUnmatchedRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ReportpicturesUnmatchedTable();
