...
import 'report_summary_copy2_model.dart';
export 'report_summary_copy2_model.dart';

class ReportSummaryCopy2Widget extends StatefulWidget {
  const ReportSummaryCopy2Widget({super.key});

  static String routeName = 'ReportSummaryCopy2';
  static String routePath = '/reportSummaryCopy2';

  @override
  State<ReportSummaryCopy2Widget> createState() =>
      _ReportSummaryCopy2WidgetState();
}

class _ReportSummaryCopy2WidgetState extends State<ReportSummaryCopy2Widget>
    with TickerProviderStateMixin {
  late ReportSummaryCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportSummaryCopy2Model());
                                                                ...
                                                                Expanded(
                                                                  child:
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      ].divide(SizedBox(width: 1.0)).around(
                                                                              SizedBox(width: 1.0)),
                                                                    ),
                                                                  ),
                                                                ),
                                                                        ...
                                                                        Expanded(
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: FutureBuilder<List<ExecutedTaskWithFieldsJsonRow>>(
                                                                                ...
                                                                                builder: (context, snapshot) {
                                                                                  ...
                                                                                  List<ExecutedTaskWithFieldsJsonRow> checkboxGroupExecutedTaskWithFieldsJsonRowList = snapshot.data!;

                                                                                  return FlutterFlowCheckboxGroup(
                                                                                    options: checkboxGroupExecutedTaskWithFieldsJsonRowList.unique((e) => e.clientName!).sortedList(keyOf: (e) => e.clientName!, desc: false).map((e) => e.clientName).withoutNulls.toList(),
                                                                                    onChanged: (val) async {
                                                                ...
                                                                if (!(_model.checkboxGroupValues !=
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child: FutureBuilder<
                                                                      ...
                                                                      future: (_model
                                                                              .requestCompleter2 ??= Completer<List<ExecutedTaskWithFieldsJsonRow>>()
                                                                            ..complete(ExecutedTaskWithFieldsJsonTable().queryRows(
                                                                              queryFn: (q) => q
                                                                                  .eqOrNull(
                                                                                    'company_name',
                                                                                    FFAppState().appAuthUserCompanyName,
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        List<ExecutedTaskWithFieldsJsonRow>
                                                                            listViewPExecutedTaskWithFieldsJsonRowList =
                                                                            snapshot.data!;
                                                                        ...
                                                                        return ListView
                                                                          ...
                                                                          scrollDirection:
                                                                              Axis.vertical,
                                                                          itemCount:
                                                                              listViewPExecutedTaskWithFieldsJsonRowList.length,
                                                                          separatorBuilder: (_, __) =>
                                                                              SizedBox(height: 10.0),
                                                                          itemBuilder:
                                                                              (context, listViewPIndex) {
                                                                            final listViewPExecutedTaskWithFieldsJsonRow =
                                                                                listViewPExecutedTaskWithFieldsJsonRowList[listViewPIndex];
                                                                            return Container(
                                                                              decoration: BoxDecoration(
                                                                                borderRadius: BorderRadius.circular(10.0),
                                                                              ),
                                                                              child: Column(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Padding(
                                                                                    ...
                                                                                    child: Builder(
                                                                                      builder: (context) {
                                                                                        final valueJsonChildren = listViewPExecutedTaskWithFieldsJsonRow.fieldsJson?.toList() ?? [];
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child: FutureBuilder<
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        List<ExecutedTaskWithFieldsJsonRow>
                                                                            listViewQExecutedTaskWithFieldsJsonRowList =
                                                                            snapshot.data!;
                                                                        ...
                                                                        return ListView
                                                                          ...
                                                                          scrollDirection:
                                                                              Axis.vertical,
                                                                          itemCount:
                                                                              listViewQExecutedTaskWithFieldsJsonRowList.length,
                                                                          separatorBuilder: (_, __) =>
                                                                              SizedBox(height: 10.0),
                                                                          itemBuilder:
                                                                              (context, listViewQIndex) {
                                                                            final listViewQExecutedTaskWithFieldsJsonRow =
                                                                                listViewQExecutedTaskWithFieldsJsonRowList[listViewQIndex];
                                                                            return Container(
                                                                              decoration: BoxDecoration(
                                                                                borderRadius: BorderRadius.circular(10.0),
                                                                              ),
                                                                              child: Column(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Padding(
                                                                                    ...
                                                                                    child: Builder(
                                                                                      builder: (context) {
                                                                                        final valueJsonChildrenSearched = listViewQExecutedTaskWithFieldsJsonRow.fieldsJson?.toList() ?? [];
